package com.monksoft.productviewer
...
class MainActivityTest {
    ...
    @Test
    fun setNewQuantity_sumLimir_increasesTextField(){
    ...
    @Test
    fun setNewQuantity_sub_sameTextField(){
        onView(withId(R.id.etNewQuantity))
    ...
    fun checkTextField_startQuantity() {
        //cuando se tiene muchos ids con el mismo nombre en una vista
